...
\begin{frame}{Bipartite matching}
    ...
    \bi
        ...
        \item \textit{see example}
            \vspace{10pt}
        \item Tomorrow we'll see an efficient algorithm for finding the maximum matching in a bipartite graph
        \item Remember that an efficient algorithm for finding maximum matchings in general graphs is not known
    \ei
\end{frame}
